...
(** [cell_to_json cell] 
    converts a cell [cell] into its json representation *)

val cell_from_json : Yojson.Basic.t -> Model.cell
(** [cell_from_json json] creates a cell from
    its json representation [json] *)
...
(** [update_cell x y data] updates the cell at coordinates
    (x, y) with new cell data. *)
