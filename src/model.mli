(** Executes simulation, handles state changes, and provides representation of world state and components*)
...
(** [get_coordinate cell] returns the zero-indexed coordinates (x,y) of [cell] *)

val simulate : world -> world
(** [simulate world] executes a simulation step *)

val clear_cell : world -> int -> int -> world
(** [set_cell x y] Clears the cell at the specified [x] and [y] coordinates.
    Pre-conditions: the coordinates must be a valid range *)

val inject_cell : world -> int -> int -> string
